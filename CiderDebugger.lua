...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/garrapato/Library/Application Support/luaglider2/dev";local SOCKET_PORT=58952;local GLIDER_MAIN_FOLDER= "/Users/garrapato/GitHub/framework-widget";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
